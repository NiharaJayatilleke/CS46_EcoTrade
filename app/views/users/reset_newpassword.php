...
<div class="reset-box">
    <div class="reset-form-box">
        ...
        <h2 style="text-align: center; font-size: 24px; color: #333; margin-bottom: 40px;">Reset Password</h2>
            ...
            <input class="input-field-reset" type="password" name="newPassword" placeholder="New password">
            ...
            <br>
            <input class="input-field-reset" type="password" name="confirmPassword" placeholder="Repeat new password">
            ...
            <input type="submit" value="Reset Password" class="reset-submit-btn"> 
        </form>
    </div>  
    <?php flash('newReset');?>
</div>
