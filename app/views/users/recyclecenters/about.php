...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/css/collectors/about.css">

    <!-- ***** Main Banner Area Start ***** -->
    <div class="main-banner" id="top">
        <video autoplay muted loop id="bg-video">
            <source src="../public/img/Recyclehome/image/3195440-uhd_3840_2160_25fps.mp4" type="video/mp4" />
        </video>
