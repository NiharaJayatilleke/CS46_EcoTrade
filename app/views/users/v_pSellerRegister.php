<?php require APPROOT.'/views/inc/header.php'; ?>
    ...
    <div class="form-container">
        ...
        <form action="<?php echo URLROOT?>/Users/pSellerRegister/" method="POST">
            <!-- username -->
            ...
            <input type="text" name="user_type" id="user_type" value="pSeller" required="" hidden="" style="display: none;">
