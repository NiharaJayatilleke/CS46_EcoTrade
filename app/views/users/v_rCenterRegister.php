<?php require APPROOT.'/views/inc/header.php'; ?>
    ...
    <div class="reg-form-container">
        ...
        <form action="<?php echo URLROOT?>/Users/rCenterRegister/" method="POST">
            <!-- username -->
            ...
            <input type="text" name="user_type" id="user_type" value="rCenter" required="" hidden="" style="display: none;">
