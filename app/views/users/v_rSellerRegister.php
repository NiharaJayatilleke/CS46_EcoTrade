<?php require APPROOT.'/views/inc/header.php'; ?>
    ...
    <div class="reg-form-container">
        ...
        <form action="<?php echo URLROOT?>/Users/rSellerRegister/" method="POST">
            <!-- username -->
            ...
            <input type="text" name="user_type" id="user_type" value="rSeller" required="" hidden="" style="display: none;">
